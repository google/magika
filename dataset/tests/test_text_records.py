...
def test_pem_blocks():
    ...
    # crt is the binary DER class; a PEM-armored certificate is pem whatever its name says.
    assert pem.validate(pem_block(b"CERTIFICATE"), frozenset({"crt"})).format_id == "pem"
