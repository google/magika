...
// errReader implements io.ReaderAt and is a helper to accumulate errors
// that may arise during reading. This allows for a simpler parsing code flow
// with a unique error check at the end of parsing.
