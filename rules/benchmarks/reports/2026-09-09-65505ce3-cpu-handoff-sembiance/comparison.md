...
| TrID | 2.48 → 2.48 | strings=True; StringZilla=5.1.2 | 95.11 → 66.85 (-29.7%) | 75.13 → 66.33 (-11.7%) | 75.03 → 68.20 (-9.1%) | 99.48 → 83.65 (-15.9%) | 186.17 → 173.63 (-6.7%) | 197.24 → 181.24 (-8.1%) | 1685.32 → 1286.28 (-23.7%) |
