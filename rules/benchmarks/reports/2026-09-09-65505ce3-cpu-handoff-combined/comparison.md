...
| TrID | 2.48 → 2.48 | strings=True; StringZilla=off | 83.06 → 70.52 (-15.1%) | 104.00 → 96.69 (-7.0%) | 76.64 → 71.43 (-6.8%) | 109.84 → 97.90 (-10.9%) | 100.82 → 81.54 (-19.1%) | 304.64 → 272.84 (-10.4%) | 5156.85 → 4850.05 (-5.9%) |
