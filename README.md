...
We release as open source a Python client (a command-line tool and an API), and an experimental TensorflowJS model. (More on our roadmap below.)

Try Magika today with our [web demo](https://google.github.io/magika/)!
