...
| TrID | 2.48 → 2.48 | strings=True; StringZilla=off | 83.06 → 84.24 (+1.4%) | 104.00 → 113.60 (+9.2%) | 76.64 → 79.07 (+3.2%) | 109.84 → 111.67 (+1.7%) | 100.82 → 105.36 (+4.5%) | 304.64 → 320.12 (+5.1%) | 5156.85 → 5433.15 (+5.4%) |
